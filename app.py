...
def main():
    ...
    st.markdown('Клиенты – это основа успеха любого бизнеса, поэтому банки заинтересованы в создании систем для более гибкой работы с ними. ')
    ...
    st.markdown('Главные выводы. В ходе проекта были созданы модели на основе логистической регрессии, Random Forest, XGBoost. При валидации моделей по метрикам "F1-score", "ROC-AUC" (0,64 и 0,79) было выявлено, что модель с наибольшей предиктивной мощностью - модель с использованием XGBoost')
